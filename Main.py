...
# d = conectancia direcionada / nd = conectancia não direcionada - **Estas medidas de conectância não servem para redes bipartidas. Estão acrescentadas ao código, pois não pretendemos delimitar a análise de redes bipartidas, possibilitando novas visualizações dentro das próximas atualizações.
n = G.number_of_nodes()
m = G.number_of_edges()
